...
<div class="content">
    <div class="main-content">
        ...
        <h2 class="header-dividing">礼品兑换处理列表</h2>
<table class="table" style="width: 800px;">
    ...
    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
            ...
            <td>
                <a type="button" href="<?php echo U("Home/Index/exapply_success?id=$vo[id]");?>" class="btn btn-primary">通过</a>
            </td>
            <td>
                <a type="button" href="<?php echo U("Home/Index/exapply_deny?id=$vo[id]");?>" class="btn btn-default">拒绝</a>
            </td>
        </tr><?php endforeach; endif; else: echo "" ;endif; ?>
    </tbody>
</table>

<h2 class="header-dividing">已处理列表</h2>
<table class="table" style="width: 800px;">
    <thead>
    <tr>
        <th>#</th>
    ...
    <tbody>
    <?php if(is_array($list_done)): $i = 0; $__LIST__ = $list_done;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
            <td><?php echo ($i); ?></td>
            <td><?php echo ($vo["exname"]); ?></td>
            <td><?php echo ($vo["realname"]); ?></td>
            <td><?php echo ($vo["username"]); ?></td>
