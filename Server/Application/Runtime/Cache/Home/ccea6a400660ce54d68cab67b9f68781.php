  ...
  <!--<![endif]-->
    ...
    <div class="navbar navbar-default" role="navigation">
        <div class="navbar-header">
          <a class="" href="index.html"><span class="navbar-brand"><span class="fa fa-paper-plane"></span> LoveInn后台管理</span></a></div>
            ...
            <form id="log" method='post' onsubmit = "return checkUser();">
                ...
                <div class="form-group">
                    <label class="radio-inline">
                        <input type="radio" name="flag" value="0" checked> 管理员
                    </label>
                    <label class="radio-inline">
                        <input type="radio" name="flag" value="1"> 组织者
                    </label>
                </div>
