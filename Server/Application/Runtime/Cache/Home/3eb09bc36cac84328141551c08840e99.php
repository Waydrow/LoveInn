...
<div class="content">
    <div class="main-content">
        ...
        <h2 class="header-dividing">待审核志愿者列表</h2>
<table class="table" style="width: 800px;">
    ...
    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h4 class="modal-title"><?php echo ($vo["realname"]); ?></h4>
                            </div>
                            <div class="modal-body">
                                <p>年龄: <?php echo ($vo["age"]); ?></p>
                                <p>性别: <?php echo ($vo["sex"]); ?></p>
                                <p>身份证号: <?php echo ($vo["idcard"]); ?></p>
                                <p>电话: <?php echo ($vo["phone"]); ?></p>
                                <p>邮箱: <?php echo ($vo["email"]); ?></p>
                                <p>个人简介: <?php echo ($vo["info"]); ?></p>
                                <p>头像: <img src="<?php echo ($vo["avatar"]); ?>" width="150px" class="img-responsive" alt="头像"></p>
                                <p>学生证: <img src="<?php echo ($vo["stucard"]); ?>" width="150px" class="img-responsive" alt="学生证"></p>
                                <p>爱心币: <?php echo ($vo["money"]); ?>个</p>
                                <p>实名认证: 已实名认证</p>
                            </div>
                            <div class="modal-footer">
                                <a type="button" href="<?php echo U("Home/Index/volunteer_auth_success?id=$vo[id]");?>" class="btn btn-default">通过</a>
                                <a type="button" href="<?php echo U("Home/Index/volunteer_auth_deny?id=$vo[id]");?>" class="btn btn-default">拒绝</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <td>
                <a type="button" href="<?php echo U("Home/Index/delvolunteer?id=$vo[id]");?>" class="btn btn-primary" onclick="del();">删除</a>
            </td>
